    ...
    fetch("/newacct", {
      ...
      .then(response =>
        this.setState({
          createdAcct:
            "Hi " +
            JSON.stringify(response.username).slice(1, -1) +
            ", Welcome To UcRev.",
          errorAcct: "",
          login: true
        })
      ...
      <div>
        ...
        >
          <div className="text-center mb-4">
            <img
              className="mb-4"
              src="https://drive.google.com/uc?export=view&id=1JGmtRC0EGRGfyzvUkDEf3OwE_4yTdjH5"
              alt=""
              width="150"
              height="150"
            />
            <p style={{ fontFamily: "Times New Roman", fontSize: "22px" }}>
              Sign up to save your favorite restaurants and reviews.
            </p>
          </div>
          <FormGroup
          ...
          <FormGroup
            ...
            validationState={this.state.validationState4}
          >
          ...
          <Button disabled={this.state.disabledSubmit} type="submit">
            Submit
          </Button>
        </form>
